...
/**
 * Created by Riyas V on 3/3/2016.
 */
public class PageTransformerPopUp implements ViewPager.PageTransformer{
    ...
    public PageTransformerPopUp(TransformType transformType) {
